...
**  - Day 3 - Friday  16th May 2026**
  ...
  - How tables connect to each other properly
  - ER Diagram design using dbdiagram.io
  - The more I learn SQL and database design, the more I understand that good systems start with a strong database structure.
...
**  - Day 4 - Friday  17th May 2026**
    ...
    -   I then moved into ASP.NET Web API, where I learned how to structure projects properly organizing models, controllers, and DbContext, setting up connection strings,
    -    handling database migrations so that schemas are automatically generated in the RDBMS.
    -    I also built endpoints to query data and return JSON responses.
    -   As I progressed, I explored cloud computing by deploying applications using Azure SQL Database for data storage and Azure App Service for backend hosting.
    -    This helped me understand how backend systems move from local development to production environments.
    -    Through this journey,
    -    I’ve been learning multiple interconnected skills hands-on: database design, SQL, API development, ASP.NET, C#, OOP, and cloud deployment.
    -     Rather than being a jack of all trades, I see this as building a strong foundation in full-stack backend and cloud systems engineering.
      
# On this repo , I will be working on sql
# Documenting for 240 days what have done 
# I will be leaning sql from scratch
